...
local brightnessarc_widget
if options.laptop == "true" then
    batteryarc_widget = require("awesome-wm-widgets.batteryarc-widget.batteryarc")
    brightnessarc_widget = require("awesome-wm-widgets.brightnessarc-widget.brightnessarc")
else
    batteryarc_widget = function(...) end
...
beautiful.useless_gap = options.gaps
